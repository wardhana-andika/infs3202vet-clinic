					...
					<div class="row">
						...
						<div id = "bookappointment" class="col-md-9">
							<section class="booking">
								...
								<hr>
								<form id="booking" action="createbooking.php" method="POST">
									<fieldset>
										<legend>Appointment Form</legend>
										<label>Preferred Date: </label>
										<input type="date" name="date" min="<?php echo date('Y-m-d'); ?>"><br><br>
										<label>Preferred Time: </label>
										<input type="time" name="time" min="08:00:00" max="17:00:00">
										<br /><br />
										...
										<br /><br />
										<div class="buttondiv">
											<input type="submit"  class="btn btn-default" value="Book an Appointment" name="book">
										</div><br><br>
									</fieldset>
								</form>
							</section>
