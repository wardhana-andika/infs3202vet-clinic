					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="list-group">
								...
								<a href="viewpersonal.php" class="list-group-item">View Personal Information</a>
								<a href="#" class="list-group-item active">Edit Personal Information</a>
							</div>
						</div>
						<!-- Content Column -->
						<div id = "editpersonal" class="col-md-9">
							<hr>
							<h2 class="parheader">Edit Personal Information</h2>
							<hr><br>
							
							<form action="update_info.php" method="POST">
									<dl>
										<dt>First Name:</dt>
											<ds><input type='text' name='fname' value="<?php echo $c_fname;?>"></ds>
										<dt>Last Name:</dt>
											<ds><input type='text' name='lname' value="<?php echo $c_lname;?>"></ds>
										<dt>Address:</dt>
											<ds><input type='text' name='address' value="<?php echo $c_address;?>"></ds>
										<dt>Phone:</dt>
											<ds><input type='text' name='phone' value="<?php echo $c_phone;?>"></ds>
										<dt>New password:</dt>
											<ds><input type='text' name='password' value="<?php echo $c_password;?>"></ds>							
									</dl><br>
