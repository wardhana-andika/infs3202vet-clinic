					 ...
					 <div class="row">
						...
						<div class="col-md-3">
							<div class="list-group">
								...
								<a href="#" class="list-group-item active">View Personal Information</a>
								<a href="editpersonal.php" class="list-group-item">Edit Personal Information</a>
							</div>
						</div>
						<!-- Content Column -->
						<div id = "viewpersonal" class="col-md-9">
							<hr>
							<h2 class="parheader">Personal Information</h2>
							<hr><br>
							
							<!--
							<div class="imagecontainer">
								<img class="fitimage" src="images/catphone.jpg" alt="phone" />
							</div>
							
							
							<div class="desccontainer"><br>
